...
func renderLanding(w http.ResponseWriter) {
	...
	fmt.Fprint(w, `<!doctype html><html><head><meta charset="utf-8"><title>APP B</title></head>
<body>
<h1>APP B</h1>
<p>You are not signed in to APP B.</p>
...
func renderError(w http.ResponseWriter, status int, message, reqID string) {
	w.Header().Set("Content-Type", "text/html; charset=utf-8")
	fmt.Fprintf(w, `<!doctype html><html><head><meta charset="utf-8"><title>APP B — Error</title></head>
<body><h1>APP B</h1><h2>Something went wrong</h2>
<p>%s</p>
<p>If this keeps happening, contact your administrator. Reference: %s</p>
<p><a href="/">Return to APP B</a></p>
