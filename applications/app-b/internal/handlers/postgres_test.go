...
import (
	...
	"github.com/SomeonesDads/seleksilabpro-2/applications/app-b/internal/config"
...
func TestMain(m *testing.M) {
	...
	if testDatabaseURL == "" {
		...
		if err != nil {
			fmt.Fprintf(os.Stderr, "app-b handler postgres setup skipped: %v\n", err)
		}
		testDatabaseURL = url
	}
	code := m.Run()
...
func startHandlerPostgres() (string, error) {
	name := "seleksilabpro-app-b-handlers-" + uuid.NewString()
...
func newTestApp(t *testing.T) *App {
	...
	cfg := config.Config{
		...
		CookieSecure:      false,
		AppID:             "00000000-0000-0000-0000-0000000000b2",
	}
